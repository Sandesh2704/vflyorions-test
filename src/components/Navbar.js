  ...
  return (
    <>
     <nav className='flex sticky top-0 items-center justify-between py-2 px-3 md:px-16 lg:px-36 bg-gray-100   shadow'>
      ...
      <Link href='/cartitem' className='flex items-center gap-2 md:gap-3 bg-yellow-500 py-2 lg:py-3 px-3 lg:px-6 rounded-xl text-base md:text-lg lg:text-xl font-medium'>
        <MdShoppingCart />
