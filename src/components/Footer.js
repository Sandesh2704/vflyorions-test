...
export default function Footer() {
  return (
    <footer className='flex flex-col gap-4 md:flex-row items-center justify-between py-5 border-t-2 border-cyan-500 px-3 md:px-16 lg:px-36 bg-white  '>
      <Link href='/' className='text-2xl md:text-3xl lg:text-4xl font-medium'>EliteShop</Link>
      <span className="block text-sm md:text-base text-gray-500   text-center">© 2023<a href="https://flowbite.com/" className="hover:underline">EliteShop™</a>. All Rights Reserved.</span>
