...
export default function Footer() {
  return (
    <footer className='flex flex-col gap-4 md:flex-row items-center justify-between py-5 border-t-2 border-cyan-500 px-3 md:px-16 lg:px-36 bg-gray-100  '>
         ...
         <span className="block text-base text-gray-500   text-center">© 2023<a href="https://flowbite.com/" class="hover:underline">EliteShop™</a>. All Rights Reserved.</span>
         <div className='flex flex-col text-center block text-base'>
<h1>Crafted with passion by Sandesh Deshmukh</h1>
