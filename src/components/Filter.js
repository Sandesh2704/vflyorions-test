    ...
    return (
        <>
            <div className='w-full h-fit border bg-white  shadow'>
                ...
                <div className={`transition-max-height duration-500 ease-in-out overflow-hidden ${isOpen ? 'max-h-fit' : 'max-h-0'} md:max-h-full md:block`}>
                    <div className='grid grid-cols-2 md:grid-cols-3 lg:flex flex-col'>
                        <div className='p-3 '>
                    ...
                    <div className='px-3 pb-3 flex justify-end'>
                        <button className='px-7 py-1 rounded-sm text-sm bg-blue-600 font-semibold text-white'>Apply</button>
                    </div>
                </div>
            </div>
        </>
